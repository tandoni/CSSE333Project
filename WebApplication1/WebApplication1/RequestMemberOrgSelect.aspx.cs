...
{
    public partial class RequestMemberOrgSelect : System.Web.UI.Page
    {
        ...
        public void populateOrgs()
        {
            ...
            con.Open();
            String commType2 = "allOrganizationsM";
        ...
        public void selectOrg(object sender, EventArgs e)
        {
            try
            {
                ...
                dropDownOrgs.Items.Clear();
                populateOrgs();
                ClientScript.RegisterStartupScript(GetType(), "myalert", "alert('You requested to be a member successfully');", true);
            }
            catch (Exception ex)
            {
