...
{
    public partial class AcceptMemberRequestOrgSelect : System.Web.UI.Page
    {
        ...
        {
            Session["EventList4"] = dropDownOrgs.SelectedItem.Text.ToString();
            Response.Redirect("AcceptMemberRequest.aspx");
        }
    }
