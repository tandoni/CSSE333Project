...
{
    public partial class EndorsesSelectOrg : System.Web.UI.Page
    {
        ...
        {
            Session["EventList7"] = dropDownOrgs.SelectedItem.Text.ToString();
            Response.Redirect("EndorsesOtherOrg.aspx");
        }
    }
}